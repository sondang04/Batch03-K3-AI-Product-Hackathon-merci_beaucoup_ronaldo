...
> Bản chấm dưới đây là lượt 1 dùng kết quả chạy live/smoke test hiện có ở `codebase/logs/eval-runs/` và các quy tắc trong spec; các case chưa có trace riêng được ghi là “đợi chấm thủ công” để tránh đánh giá bừa.
